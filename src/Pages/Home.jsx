...
const Home = () => {
  return (
    <div>
      ...
      <section
        id="intro"
        className="md:pt-[236px] md:pb-[102px] pt-28 pb-10 px-2 md:px-0 bg-[#FAE3B6] md:rounded-b-[20px] rounded-b-[8px]"
      >
      ...
      <section
        id="new_collection"
        className="md:pt-[217px] md:pb-[299px] sm:pb-[155px] pt-12 bg-white"
      >
      ...
      <section
        id="best_seller"
        className="bg-[#CFA485] md:pt-9 md:pb-[191px] pb-14 pt-4"
      >
