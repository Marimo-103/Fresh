    ...
    <nav className='md:px-[60px] md:pt-[47px] px-2 pt-1 absolute top-0 left-1/2 -translate-x-1/2 w-full'>
      <Container className='flex justify-between items-center'>
        ...
        <div className="btns flex gap-[10px]">
          <button className='md:py-[11px] md:px-[28px] py-1 px-[13px] bg-[#FDBB57] border border-[#FFD687] md:rounded-[10px] rounded-[5px] duration-300 hover:text-[#000] hover:bg-transparent md:text-2xl text-[10px] text-[#050505] font-Poppins md:font-semibold'>
            <Link to='/log/in'>
            Login
            </Link>
          </button>
          <button className='md:py-[11px] md:px-[15px] py-1 px-[6px] bg-[#FDBB57] border border-[#FFD687] md:rounded-[10px] rounded-[5px] duration-300 hover:text-[#000] hover:bg-transparent md:text-2xl text-[10px] text-[#050505] font-Poppins md:font-semibold'>
            <Link to='/sign/up'>
              Sign up
            </Link>
          </button>
